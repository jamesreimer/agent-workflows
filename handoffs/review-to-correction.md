...
- [Architectural Reasoning (AR)](../PROVENANCE.md#architectural-reasoning), §§5, 8, 11–12.
- [Operational Execution Contract (OEC)](../PROVENANCE.md#operational-execution-contract), §§5–13.
- [Shared Asset Provenance (SAP)](../PROVENANCE.md#shared-asset-provenance), §§5–8.
